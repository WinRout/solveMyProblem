...
def main():
    ...
    input_file = json.loads(sys.argv[1])  # Get absolute path
    num_vehicles = input_file['num_vehicles']
    depot = input_file['depot']
    max_distance = input_file['max_distance']
    # Read JSON file
    locations = input_file['Locations']
